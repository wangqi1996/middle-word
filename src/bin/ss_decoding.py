...
from src.ss_main import train

parser = argparse.ArgumentParser()

parser.add_argument('--model_name', type=str, default='Transform',
...
parser.add_argument('--log_path', type=str, default="/home/wangdq/save/log/l2r/",
                    help="The path for saving tensorboard logs. Default is ./log")

parser.add_argument('--saveto', type=str, default="/home/wangdq/save/model/l2r/",
...
parser.add_argument("--valid_path", type=str, default="/home/wangdq/save/valid/l2r",
...
def run(**kwargs):
    ...
    args.config_path = r'/home/wangdq/code/python/nju_nlp/configs/ss_configs.yaml'
    args.use_gpu = True
